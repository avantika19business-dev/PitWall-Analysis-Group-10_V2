...
from theme import (
    ...
    F1_RED, F1_BLACK, F1_WHITE, F1_SILVER, F1_GREY, F1_DGREY, F1_GOLD,
    ACCENT_TEAL, ACCENT_GREEN, ACCENT_AMBER,
    PLAN_COLORS, CHANNEL_COLORS, NPS_COLORS, CHURN_COLORS,
    RISK_COLORS, SEGMENT_COLORS,
)
...
def render(subs: pd.DataFrame, sess: pd.DataFrame, mrr: pd.DataFrame) -> None:
    ...
    with col3:
        ...
        fig3 = go.Figure(go.Bar(
            ...
            textfont=dict(color=F1_BLACK, size=11),
    ...
    with col4:
        ...
        fig4 = go.Figure(go.Bar(
            ...
            marker=dict(
                ...
                showscale=True,
                colorbar=dict(title="Avg Score", tickfont=dict(color="#6B7280"), len=0.8),
            ),
    ...
    with col5:
        ...
        fig5.update_traces(
            ...
            textfont=dict(color=F1_BLACK, size=13),
    ...
    fig9 = go.Figure(go.Heatmap(
        ...
        colorbar=dict(title="Pearson r", tickfont=dict(color="#6B7280")),
    ))
